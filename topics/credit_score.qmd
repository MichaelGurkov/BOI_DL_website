...
Batch size `32` is a widely used practical default because:  
- It fits easily in memory on most machines.  
- It provides enough averaging to stabilize gradients.  
- Empirically, it often yields good convergence speed.
